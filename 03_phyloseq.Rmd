...
```
Certaines espèces sont retrouvé que une fois dans les échantillons comme les  Campilobacterota, Hydrogenedentes,Dependentiae, Elusimicrobiota. 
Le phylum le plus important est celui des Proteobacteria avec ensuitre celui des Bacteroidota.
Il y a deu
